...
import type { CreateTaskPushNotificationConfigRequest as _a2a_v1_CreateTaskPushNotificationConfigRequest, CreateTaskPushNotificationConfigRequest__Output as _a2a_v1_CreateTaskPushNotificationConfigRequest__Output } from '../../a2a/v1/CreateTaskPushNotificationConfigRequest';
...
import type { GetAgentCardRequest as _a2a_v1_GetAgentCardRequest, GetAgentCardRequest__Output as _a2a_v1_GetAgentCardRequest__Output } from '../../a2a/v1/GetAgentCardRequest';
...
import type { TaskSubscriptionRequest as _a2a_v1_TaskSubscriptionRequest, TaskSubscriptionRequest__Output as _a2a_v1_TaskSubscriptionRequest__Output } from '../../a2a/v1/TaskSubscriptionRequest';
...
export interface A2AServiceClient extends grpc.Client {
   ...
   */
  CreateTaskPushNotificationConfig(argument: _a2a_v1_CreateTaskPushNotificationConfigRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_a2a_v1_TaskPushNotificationConfig__Output>): grpc.ClientUnaryCall;
  CreateTaskPushNotificationConfig(argument: _a2a_v1_CreateTaskPushNotificationConfigRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_a2a_v1_TaskPushNotificationConfig__Output>): grpc.ClientUnaryCall;
  CreateTaskPushNotificationConfig(argument: _a2a_v1_CreateTaskPushNotificationConfigRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_a2a_v1_TaskPushNotificationConfig__Output>): grpc.ClientUnaryCall;
  CreateTaskPushNotificationConfig(argument: _a2a_v1_CreateTaskPushNotificationConfigRequest, callback: grpc.requestCallback<_a2a_v1_TaskPushNotificationConfig__Output>): grpc.ClientUnaryCall;
  /**
   * Set a push notification config for a task.
   */
  createTaskPushNotificationConfig(argument: _a2a_v1_CreateTaskPushNotificationConfigRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_a2a_v1_TaskPushNotificationConfig__Output>): grpc.ClientUnaryCall;
   ...
   */
  GetAgentCard(argument: _a2a_v1_GetAgentCardRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_a2a_v1_AgentCard__Output>): grpc.ClientUnaryCall;
  GetAgentCard(argument: _a2a_v1_GetAgentCardRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_a2a_v1_AgentCard__Output>): grpc.ClientUnaryCall;
  GetAgentCard(argument: _a2a_v1_GetAgentCardRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_a2a_v1_AgentCard__Output>): grpc.ClientUnaryCall;
  GetAgentCard(argument: _a2a_v1_GetAgentCardRequest, callback: grpc.requestCallback<_a2a_v1_AgentCard__Output>): grpc.ClientUnaryCall;
  /**
   * GetAgentCard returns the agent card for the agent.
   */
  getAgentCard(argument: _a2a_v1_GetAgentCardRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_a2a_v1_AgentCard__Output>): grpc.ClientUnaryCall;
   ...
   */
  TaskSubscription(argument: _a2a_v1_TaskSubscriptionRequest, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_a2a_v1_StreamResponse__Output>;
  TaskSubscription(argument: _a2a_v1_TaskSubscriptionRequest, options?: grpc.CallOptions): grpc.ClientReadableStream<_a2a_v1_StreamResponse__Output>;
  /**
   * TaskSubscription is a streaming call that will return a stream of task
   * update events. This attaches the stream to an existing in process task.
   * If the task is complete the stream will return the completed task (like
...
export interface A2AServiceHandlers extends grpc.UntypedServiceImplementation {
   ...
   * Set a push notification config for a task.
   */
  CreateTaskPushNotificationConfig: grpc.handleUnaryCall<_a2a_v1_CreateTaskPushNotificationConfigRequest__Output, _a2a_v1_TaskPushNotificationConfig>;
   ...
   * GetAgentCard returns the agent card for the agent.
   */
  GetAgentCard: grpc.handleUnaryCall<_a2a_v1_GetAgentCardRequest__Output, _a2a_v1_AgentCard>;
   ...
   * GetTask) and close the stream.
   */
  TaskSubscription: grpc.handleServerStreamingCall<_a2a_v1_TaskSubscriptionRequest__Output, _a2a_v1_StreamResponse>;
...
export interface A2AServiceDefinition extends grpc.ServiceDefinition {
  ...
  CreateTaskPushNotificationConfig: MethodDefinition<_a2a_v1_CreateTaskPushNotificationConfigRequest, _a2a_v1_TaskPushNotificationConfig, _a2a_v1_CreateTaskPushNotificationConfigRequest__Output, _a2a_v1_TaskPushNotificationConfig__Output>
  ...
  GetAgentCard: MethodDefinition<_a2a_v1_GetAgentCardRequest, _a2a_v1_AgentCard, _a2a_v1_GetAgentCardRequest__Output, _a2a_v1_AgentCard__Output>
  ...
  TaskSubscription: MethodDefinition<_a2a_v1_TaskSubscriptionRequest, _a2a_v1_StreamResponse, _a2a_v1_TaskSubscriptionRequest__Output, _a2a_v1_StreamResponse__Output>
}
