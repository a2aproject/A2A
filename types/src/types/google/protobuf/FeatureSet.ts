...
export type _google_protobuf_FeatureSet_VisibilityFeature_DefaultSymbolVisibility__Output =
  (typeof _google_protobuf_FeatureSet_VisibilityFeature_DefaultSymbolVisibility)[keyof typeof _google_protobuf_FeatureSet_VisibilityFeature_DefaultSymbolVisibility];
...
export type _google_protobuf_FeatureSet_EnforceNamingStyle__Output =
  (typeof _google_protobuf_FeatureSet_EnforceNamingStyle)[keyof typeof _google_protobuf_FeatureSet_EnforceNamingStyle];
...
export type _google_protobuf_FeatureSet_EnumType__Output =
  (typeof _google_protobuf_FeatureSet_EnumType)[keyof typeof _google_protobuf_FeatureSet_EnumType];
...
export type _google_protobuf_FeatureSet_FieldPresence__Output =
  (typeof _google_protobuf_FeatureSet_FieldPresence)[keyof typeof _google_protobuf_FeatureSet_FieldPresence];
...
export type _google_protobuf_FeatureSet_JsonFormat__Output =
  (typeof _google_protobuf_FeatureSet_JsonFormat)[keyof typeof _google_protobuf_FeatureSet_JsonFormat];
...
export type _google_protobuf_FeatureSet_MessageEncoding__Output =
  (typeof _google_protobuf_FeatureSet_MessageEncoding)[keyof typeof _google_protobuf_FeatureSet_MessageEncoding];
...
export type _google_protobuf_FeatureSet_RepeatedFieldEncoding__Output =
  (typeof _google_protobuf_FeatureSet_RepeatedFieldEncoding)[keyof typeof _google_protobuf_FeatureSet_RepeatedFieldEncoding];
...
export type _google_protobuf_FeatureSet_Utf8Validation__Output =
  (typeof _google_protobuf_FeatureSet_Utf8Validation)[keyof typeof _google_protobuf_FeatureSet_Utf8Validation];
