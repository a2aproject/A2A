...
import type {
  FeatureSet as _google_protobuf_FeatureSet,
  FeatureSet__Output as _google_protobuf_FeatureSet__Output,
} from "../../google/protobuf/FeatureSet";
import type {
...
import type {
  FieldBehavior as _google_api_FieldBehavior,
  FieldBehavior__Output as _google_api_FieldBehavior__Output,
} from "../../google/api/FieldBehavior";
import type {
  Edition as _google_protobuf_Edition,
  Edition__Output as _google_protobuf_Edition__Output,
} from "../../google/protobuf/Edition";
...
export type _google_protobuf_FieldOptions_CType__Output =
  (typeof _google_protobuf_FieldOptions_CType)[keyof typeof _google_protobuf_FieldOptions_CType];
...
export type _google_protobuf_FieldOptions_JSType__Output =
  (typeof _google_protobuf_FieldOptions_JSType)[keyof typeof _google_protobuf_FieldOptions_JSType];
...
export type _google_protobuf_FieldOptions_OptionRetention__Output =
  (typeof _google_protobuf_FieldOptions_OptionRetention)[keyof typeof _google_protobuf_FieldOptions_OptionRetention];
...
export type _google_protobuf_FieldOptions_OptionTargetType__Output =
  (typeof _google_protobuf_FieldOptions_OptionTargetType)[keyof typeof _google_protobuf_FieldOptions_OptionTargetType];
...
export interface FieldOptions {
  ...
  ".google.api.field_behavior"?: _google_api_FieldBehavior[];
}
...
export interface FieldOptions__Output {
  ...
  ".google.api.field_behavior": _google_api_FieldBehavior__Output[];
}
