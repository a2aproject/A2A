...
- **`agentType`** (optional, enum): An optional categorization of the agent type. This helps consumers identify the kind of agent they are interacting with. See [`AgentType`](#AgentType) for possible values.
