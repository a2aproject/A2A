...
The A2A Protocol is an open source project under the Linux Foundation, contributed by Google, under the [Apache License 2.0](LICENSE), and is open to contributions from the community.
